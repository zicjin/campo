...
(function() {
  $(document).on('click', '.comment [data-reply-to]', function() {
    ...
    return glo_editor.placeholderEl.hide();
  });
...
(function() {
  ...
  Uploader = (function(_super) {
    ...
    Uploader.prototype.xhrUpload = function(file) {
      ...
      formData.append("attachment[file]", file.obj); //zic change from 'upload_file'
...
(function() {
  ...
  window.glo_touchDevice = __indexOf.call(document.documentElement, 'ontouchstart') >= 0;
